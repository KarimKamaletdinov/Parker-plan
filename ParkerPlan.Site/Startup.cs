...
using ParkerPlan.CommandHandlers.Worker;
...
namespace ParkerPlan.Site
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IQueryHandler<GetWorkers, WorkerDto[]>, GetWorkersQueryHandler>();
            services.AddScoped<ICommandHandler<UpdateWorker>, UpdateWorkerCommandHandler>();
            services.AddScoped<ICommandHandler<InsertWorker>, InsertWorkerCommandHandler>();
            services.AddScoped<ICommandHandler<DeleteWorker>, DeleteWorkerCommandHandler>();
            services.AddScoped<SqlWorkerRepository>();
            services.AddScoped<PasswordService>();
            services.AddScoped<PriceCalculatorService>();
            services.AddScoped<EnumParser>();
            services.AddScoped<FiltersService>();
